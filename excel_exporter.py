...
from pandas import read_sql, to_datetime, concat, Series
from sqlite3 import connect
from os.path import join
from os import getcwd
from io import BytesIO
from styleframe import ExcelWriter, StyleFrame, Styler
from styleframe.utils import horizontal_alignments, colors, underline, number_formats
...
main_styler = Styler(horizontal_alignment=horizontal_alignments.left, date_format='YYYY-MM-DD', font_color=colors.black,
                     underline=None)
...
with ExcelWriter(path=excel_file, mode='w') as writer:
    for table_name in table_names:
        ...
        print(styleframe)
        styleframe.to_excel(excel_writer=writer, sheet_name=table_name.__getitem__(0), columns_and_rows_to_freeze='C2')
